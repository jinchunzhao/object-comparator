package io.github.jinchunzhao.comparator.collectionfieldtype.collection;

import io.github.jinchunzhao.comparator.pojo.collectionfieldtype.Category;
import io.github.jinchunzhao.comparator.pojo.collectionfieldtype.Goods;
...
//        ObjectComparator = new ObjectComparator();
    ...
    @Test public void testEquals() throws Exception {
        ...
        Category category = new Category("phone",goodList);
        ...
        List<Goods> goodList1 = new ArrayList<>();
        goodList1.add(goods2);
        goodList1.add(goods3);

        Category category1 = new Category("phone",goodList1);
    ...
    @Test public void testEquals1() throws Exception {
        ...
        Category category1 = new Category("Mobile",goodList1);
